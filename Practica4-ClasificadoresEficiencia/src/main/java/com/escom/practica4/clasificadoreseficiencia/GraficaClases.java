 ...
 * @author fenix
 */
public class GraficaClases extends JFrame{
    ...
    public GraficaClases(int coorx, int coory, Clase rasgos[]){
        ...
        for(int i=0; i<rasgos.length; i++){
            ...
            for(int j=0; j<aux; j++){
                ...
                double temp1=rasgos[i].getClase()[0][j];
                double temp2=rasgos[i].getClase()[1][j];
