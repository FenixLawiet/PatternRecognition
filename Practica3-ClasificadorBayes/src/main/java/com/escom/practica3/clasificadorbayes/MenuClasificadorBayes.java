...
/*
    ...
    Menu del Clasificador de Bayes
*/

public class MenuClasificadorBayes {
    ...
    public MenuClasificadorBayes(){
    
        //VACIO
    }
    
    public void ClasificadorBayes(){
        ...
        System.out.println("************CLASIFICADOR BAYES-MAHALANOBIS-EUCLIDIANO************");
